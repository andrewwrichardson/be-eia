...
exports.retrieveOSMData = async (bbox, project_id, assessmentAreaFC) => {
    ...
    const { data } = await OSMApi.get(
        `/interpreter/?data=[out:json][timeout:5000];(node["historic"](${minLat},${minLong},${maxLat},${maxLong});way["historic"](${minLat},${minLong},${maxLat},${maxLong});node["historic"](${minLat},${minLong},${maxLat},${maxLong});way["waterway"](${minLat},${minLong},${maxLat},${maxLong});node["waterway"](${minLat},${minLong},${maxLat},${maxLong});relation["waterway"](${minLat},${minLong},${maxLat},${maxLong});way["natural"="water"](${minLat},${minLong},${maxLat},${maxLong});node["natural"="water"](${minLat},${minLong},${maxLat},${maxLong});relation["natural"="water"](${minLat},${minLong},${maxLat},${maxLong});way["natural"="wood"](${minLat},${minLong},${maxLat},${maxLong});node["natural"="wood"](${minLat},${minLong},${maxLat},${maxLong});relation["natural"="wood"](${minLat},${minLong},${maxLat},${maxLong});way["natural"="tree"](${minLat},${minLong},${maxLat},${maxLong});node["natural"="tree"](${minLat},${minLong},${maxLat},${maxLong});relation["natural"="tree"](${minLat},${minLong},${maxLat},${maxLong});way["historic"](${minLat},${minLong},${maxLat},${maxLong});node["historic"](${minLat},${minLong},${maxLat},${maxLong});way["building"](${minLat},${minLong},${maxLat},${maxLong});node["addr:street"](${minLat},${minLong},${maxLat},${maxLong});relation["building"](${minLat},${minLong},${maxLat},${maxLong}););out;>;out skel qt;`
    );
