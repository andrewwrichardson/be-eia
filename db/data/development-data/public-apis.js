module.exports = [
  ...
  {
    url: `https://lz4.overpass-api.de/api/interpreter/?data=[out:json][timeout:25];(node["natural"="water"](54.581899363448,-5.9250211715698,54.591759561641,-5.9067177772522);way["natural"="water"](54.581899363448,-5.9250211715698,54.591759561641,-5.9067177772522);relation["natural"="water"](54.581899363448,-5.9250211715698,54.591759561641,-5.9067177772522););out;>;out skel qt;`,
    source: "Open Street Map",
    category: "Nature Conservation",
  },
  {
    url: `https://lz4.overpass-api.de/api/interpreter/?data=[out:json][timeout:25];(node["railway"](54.587628640463,-5.9330946207046,54.590093567089,-5.9285187721252);way["railway"](54.587628640463,-5.9330946207046,54.590093567089,-5.9285187721252);relation["railway"](54.587628640463,-5.9330946207046,54.590093567089,-5.9285187721252););out;>;out skel qt;`,
    source: "Open Street Map",
    category: "Community and Private Assets",
  },
];
